    ...
    <div class="col-md-12">
      <div class="box box-default">
        <div class="box-header with-border">
          ...
          <br>
              <h4 class="text-bold part1" style="margin-left: 15px;">Please complete and submit this Online Registration Form and provide full details to Sunshine B2B.</h4> 
                   ...
                   <div class="form-group col-md-12">
                    <label for="exampleInputEmail1">Supply Type</label> <span class="text-danger">*</span> <br>
                      ...
                      { 
                        ...
                        > 
                        <?php 
                      }else if($key->memo_type == 'outright' || $key->memo_type == 'waive_outright')
                      {?> checked
                        > 
                        <?php 
                      }
