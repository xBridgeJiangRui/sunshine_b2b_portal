...
<!--           <button title="Confirm"  onclick="confirm_modal2('<?php echo site_url('general/confirm'); ?>?refno=<?php echo $_REQUEST['trans'] ?>&customer_guid=<?php echo $_SESSION['customer_guid'] ?>&table=grmain&col_guid=refno&loc=<?php echo $_REQUEST['loc'] ?>')" 
        ...
        <?php if($_SESSION['frommodule'] == 'b2b_gr' &&$get_DN_detail->num_rows() == 0 && $paybyinvoice_got_grda == '1' && $accpt_gr_status != 'Confirmed' && $accpt_gr_status != 'confirmed') 
          { 
        ?>
<!--         <button title="Confirm"  onclick="confirm_modal2('<?php echo site_url('general/confirm'); ?>?refno=<?php echo $_REQUEST['trans'] ?>&customer_guid=<?php echo $_SESSION['customer_guid'] ?>&table=grmain&col_guid=refno&loc=<?php echo $_REQUEST['loc'] ?>')" 
          type="button" class="btn btn-app" style="color:#008D4C"  data-toggle="modal" data-target="#confirm_gr" data-name="<?php echo $_REQUEST['trans'] ?>" >
                    ...
                    <table id="einvoice_display" class="tablesorter table table-striped table-bordered table-hover" style="font-size:12px;width:100%"> 
                      <form method="post" action="<?php echo site_url('B2b_gr/edit_gr_header?refno='.$_REQUEST['trans'].'&loc='.$_REQUEST['loc'] ); ?>" id="form_EGRH" name="form_EGRH" >
                        ...
                        <tr>
                          ...
                          <th style="width:3%">Tax</th>
                          <th style="width:8%">Amount Inc Tax</th>
                          <th style="width:10%;visibility:hidden;border-top: 1px solid white;border-bottom: 1px solid white;border-right: 1px solid white;">Amount Inc Tax</th>
                          <th style="width:10%;visibility:hidden;border-top: 1px solid white;border-bottom: 1px solid white;border-right: 1px solid white;">Amount Inc Tax</th>
                          <th style="width:13%;visibility:hidden;border-top: 1px solid white;border-bottom: 1px solid white;border-right: 1px solid white;">Amount Inc Tax</th>
                          ...
                          foreach($check_child as $row => $value)
                        {
                          ?>
                            <tr>
                              ...
                              <td><?php echo $value['inv_qty'];echo ' '; echo $value['um'];?></td> <!--inv_qty-->
                              <td style="text-align: right"><?php echo number_format($value['inv_unitprice'],2);?></td> <!--inv_unitprice-->
