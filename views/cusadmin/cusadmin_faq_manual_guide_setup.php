                  ...
                  <table id="manual_guide_table" class="table table-bordered table-hover" width="100%" cellspacing="0">
                    ...
                    <?php foreach($manual_guide->result() as $row) { ?>
                      <tr>
                        ...
                        manual_guid="<?php echo $row->manual_guid ?>"
                        ...
                        ><i class="fa fa-edit"></i>
                          ...
                          data-manual_guid="<?php echo $row->manual_guid ?>"
                          data-title="<?php echo $row->title ?>" 
...
$(document).on('click', '#manual_guide_table .Manual_Edit', function(){
  ...
  var manual_guid = $(this).attr('manual_guid')
  ...
  methodd += '<div class="col-md-12"> <label>Retailer</label> <select name="customer_guid" class="form-control input-sm">';

  <?php 
  $methodd = '';
  foreach($customer->result() as $row3)
  {
    $methodd .= '<option value="'.$row3->acc_guid.'">'.$row3->acc_name.'</option>';
  }
  ?>

  methodd += '<?php echo $methodd;?>';
  ...
  methodd += '<div class="col-md-12"><input value="'+manual_guid+'" required="true" type="hidden" id="manual_guid" name="manual_guid" class="form-control" value="" /></div>';
...
$(document).on('click', '#manual_guide_table .Manual_Delete', function(){
  ...
  var manual_guid = $(this).attr('data-manual_guid')
  var title = $(this).attr('data-title')
  var file_name = $(this).attr('file_name')
  ...
  methodd += '<div class="col-md-12"><input value="'+manual_guid+'" required="true" type="hidden" id="manual_guid" name="manual_guid" class="form-control"/></div>';
