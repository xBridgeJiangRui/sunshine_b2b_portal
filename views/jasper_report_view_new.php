...
<!--               <form role="form" method="POST" id="myForm" action="<?php echo site_url('general/po_filter');?>"> -->
              <?php if(in_array('date',$input_setting_array))
              {
              ?>
            ...
            <div class="row">
<!--               <form role="form" method="POST" id="myForm" action="<?php echo site_url('general/po_filter');?>"> -->
              <?php if(in_array('code',$input_setting_array))
              {
              ?>
              <div class="col-md-2"><b>Code</b></div>
              <div class="col-md-8">
                <select id="consign_code" name="consign_code[]" class="form-control" required>
...
<!--                     <button id="consign_code_all" class="btn btn-primary" >ALL</button>
            ...
            <div class="row">
<!--               <form role="form" method="POST" id="myForm" action="<?php echo site_url('general/po_filter');?>"> -->
              <?php if(in_array('location',$input_setting_array))
              {
              ?>
      ...
      <div class="box box-success">
        ...
        <div class="box-body" id="acc_concepts">
          <div id="accconceptCheck">
            <embed id="embed" height="750px" width="100%" src="<?php echo site_url('Report_jasper_controller/jasper_report_new_view');?>?link2=<?php echo $_REQUEST['link'];?>"></embed>
          </div>

          If report not showing, please click this link: <a id="jasper_a_link" href="<?php echo site_url('Report_jasper_controller/jasper_report_new_view');?>?link2=<?php echo $_REQUEST['link'];?>" download>View Report</a>
