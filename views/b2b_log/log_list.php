          ...
          <div class="col-md-12">
            <div class="row">
              ...
              <select class="form-control select2" name="user_option" id="user_option">
                <option value="">-Select Retailer & Supplier-</option>
              </select>
              </div>
              <div class="clearfix"></div><br>
...
$(document).ready(function() {
  ...
  $(document).on('click','#search_data',function(){
    ...
    log_table(table_option,retailer_option,supplier_option,user_option,date_from,date_to,period_code);

  });//close search button

  log_table = function(table_option,retailer_option,supplier_option,user_option,date_from,date_to,period_code) {
    $.ajax({
      url: "<?php echo site_url('Portal_logs/run_log_table'); ?>",
      method: "POST",
      data:{table_option:table_option,retailer_option:retailer_option,supplier_option:supplier_option,user_option:user_option,date_from:date_from,date_to:date_to,period_code:period_code},
      beforeSend: function() {
        swal.fire({
