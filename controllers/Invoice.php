...
class Invoice extends CI_Controller {
    ...
    {   
        ...
        $url = $this->jasper_ip.'/jasperserver/rest_v2/reports/reports/B2BReports/Invoices_New.pdf?db_be=b2b_invoice&inv_guid='.$inv_guid;
        // echo $url;die;
        $curl = curl_init();
    ...
    public function view_cn_report()
    {   
        $inv_guid = $_REQUEST['inv_guid'];
        $inv_no = $_REQUEST['inv_number'];
        $url = $this->jasper_ip.'/jasperserver/rest_v2/reports/reports/B2BReports/Invoices_CN.pdf?db_be=b2b_invoice&inv_guid='.$inv_guid;
        // echo $url;die;
        $curl = curl_init();
    ...
    public function view_report_cn()
    {   
        $inv_guid = $_REQUEST['inv_guid'];
        $inv_no = $_REQUEST['inv_number'];
        $url = $this->jasper_ip.'/jasperserver/rest_v2/reports/reports/B2BReports/Invoices_CN.pdf?db_be=b2b_invoice&inv_guid='.$inv_guid;
