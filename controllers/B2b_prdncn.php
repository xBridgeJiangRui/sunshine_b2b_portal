...
class b2b_prdncn extends CI_Controller
{
    ...
    public function prdncn_report()
    {
        ...
        if($doc_type == 'CN')
        {
            $url = $this->jasper_ip . "/jasperserver/rest_v2/reports/reports/PandaReports/Backend_PRCN/main_jrxml.pdf?refno=".$refno;
        ...
        {
            $url = $this->jasper_ip . "/jasperserver/rest_v2/reports/reports/PandaReports/Backend_PRDN/main_jrxml.pdf?refno=".$refno;
