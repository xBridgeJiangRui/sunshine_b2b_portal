...
class panda_return_collection extends CI_Controller
{
    ...
    */
    ...
    public function return_collection_child()
    {
        ...
        //     $local_ip = '10.10.0.251';
        //     $module = 'rest_b2b/index.php/Return_image/strb';
        //     $to_shoot_url2 = $local_ip."/".$module;
        //     // echo $to_shoot_url2;die;
        //     $data = array();
        //     $data[] = array(
        //         'customer_guid' => $customer_guid,
        //         'refno' => $refno,
        //         'loc_group' => $get_current_status->row('loc_group'),
        //         'period_code' => $get_current_status->row('period_code'),
        //     );
        ...
        //         {
        //             // echo json_encode($output->result);die;
        //             $print_image = $output->print_image;
        //             $dis_path_show_array_total = $output->result;
        //             // echo $dis_path_show_array_total;die;
        //             // echo 'success';
        //         }
        //         else
        //         {
        //             $print_image = 0;
        //             $dis_path_show_array_total = array();
        //             // echo 'unsuccess';
        //         }
        //         // echo 'got status';
        //     }
        ...
        //     }
            ...
            $data = array(
                ...
                //'dis_path_show_array' => $dis_path_show_array_total,
