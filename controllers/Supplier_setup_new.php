...
class Supplier_setup_new extends CI_Controller
{
    ...
    public function reg_supplier_table()
    {
        ...
        foreach ($result->result() as $row) {
            ...
            $nestedData['old_supplier_name'] = $row->old_supplier_name;
    ...
    public function create()
    {
        if ($this->session->userdata('loginuser') == true && $this->session->userdata('userid') != '') {
            ...
            $old_supplier_name = strtoupper($this->input->post('old_supplier_name'));
    ...
    public function create_group()
    {
        if ($this->session->userdata('loginuser') == true && $this->session->userdata('userid') != '') {
            ...
            if ($mode == 'create') {
                ...
                // ninso update HQ and NKWH outlet
    ...
    public function create_action()
    {
        if ($this->session->userdata('loginuser') == true && $this->session->userdata('userid') != '') {
            ...
            $query_supplier_guid = $this->db->query("SELECT supplier_guid FROM acc_concept WHERE concept_name = '" . $this->input->post('concept') . "' ");
    ...
    public function update_action()
    {
        if ($this->session->userdata('loginuser') == true && $this->session->userdata('userid') != '') {
            ...
            $query_branch_guid = $this->db->query("SELECT branch_group_guid FROM acc_branch WHERE branch_name = '" . $this->input->post('branch_name') . "' ");
